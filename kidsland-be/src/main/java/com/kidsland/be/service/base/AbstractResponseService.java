...
import com.kidsland.be.utils.KidslandUtils;
...
import static com.kidsland.be.constants.Status.ERROR;
...
public abstract class AbstractResponseService<DTO extends ItemDTO> {
    ...
    protected ResponseEntity<Result> createNullItemResponse() {
        Result result = new Result();
        Error error = new Error().setErrorContent("Null item cannot be registered.");
